...
local function on_attach(client,bufnr)
  ...
  if vim.loop.cwd() == admintool_path then
    ...
    buf_set_keymap('n','<space>fa',':Dispatch zsh $HOME/dotfiles/tmux-workspace-script/flutter-run-admintool.sh<CR>',opts)
  else
    buf_set_keymap('n','<space>fa',':FlutterRun',opts)
  end

  buf_set_keymap('n','<space>fq',':FlutterQuit<CR>',opts)
  buf_set_keymap('n','<space>fq',':Dispatch zsh $HOME/dotfiles/tmux-workspace-script/flutter-stop-admintool.sh<CR>',opts)
