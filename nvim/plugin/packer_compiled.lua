...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline-history", "cmp-copilot", "cmp-cmdline", "cmp-path", "cmp-tmux", "cmp_luasnip", "cmp-buffer" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
