...
_G.packer_plugins = {
  ...
  ["hop.nvim"] = {
    config = { "\27LJ\2\n)\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\14hop_setup\frequire\0" },
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/hop.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-copilot", "cmp-path", "cmp-tmux", "cmp-treesitter", "cmp_luasnip", "cmp-fuzzy-path" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
...
try_loadstring("\27LJ\2\n)\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\14hop_setup\frequire\0", "config", "hop.nvim")
