...
_G.packer_plugins = {
  ...
  ["gruvbox.nvim"] = {
    loaded = true,
    path = "/Users/TVG/.local/share/nvim/site/pack/packer/start/gruvbox.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline-history", "cmp-cmdline", "cmp-copilot", "cmp-path", "cmp-tmux", "cmp_luasnip" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["vim-xcode"] = {
    loaded = true,
    path = "/Users/TVG/.local/share/nvim/site/pack/packer/start/vim-xcode",
