...
_G.packer_plugins = {
  ...
  ["auto-pairs"] = {
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/auto-pairs",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-vsnip", "cmp-buffer", "vim-vsnip" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["vim-silicon"] = {
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/vim-silicon",
