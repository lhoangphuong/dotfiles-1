...
_G.packer_plugins = {
  ...
  ["cmp-fuzzy-path"] = {
    ...
    url = "https://github.com/huylg/cmp-fuzzy-path"
  },
  ["cmp-nvim-lsp"] = {
    loaded = true,
  ...
  ["inc-rename.nvim"] = {
    ...
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/inc-rename.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-path", "cmp-copilot", "cmp-buffer", "cmp-fuzzy-path", "cmp-tmux", "cmp-treesitter", "cmp_luasnip" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "playground", "nvim-treesitter-refactor", "nvim-treesitter-rescript" },
    loaded = true,
    only_config = true
  },
