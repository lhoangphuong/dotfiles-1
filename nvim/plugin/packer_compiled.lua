...
_G.packer_plugins = {
  ...
  ["copilot-cmp"] = {
    after_files = { "/Users/hlg/.local/share/nvim/site/pack/packer/opt/copilot-cmp/after/plugin/copilot_cmp.lua" },
    load_after = {
      ["copilot.lua"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/opt/copilot-cmp",
  ...
  ["copilot.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/opt/copilot.lua",
  ...
  ["lualine.nvim"] = {
    config = { "\27LJ\2\nn\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\foptions\1\0\0\1\0\2\17globalstatus\2\ntheme\15catppuccin\nsetup\flualine\frequire\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-tmux", "cmp_luasnip", "cmp-cmdline", "copilot-cmp", "cmp-path" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
