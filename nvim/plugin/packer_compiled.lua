...
_G.packer_plugins = {
  ...
  ["copilot-cmp"] = {
    after_files = { "/Users/TVG/.local/share/nvim/site/pack/packer/opt/copilot-cmp/after/plugin/copilot_cmp.lua" },
    load_after = {
      ["copilot.lua"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/Users/TVG/.local/share/nvim/site/pack/packer/opt/copilot-cmp",
  ...
  ["copilot.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/TVG/.local/share/nvim/site/pack/packer/opt/copilot.lua",
    url = "https://github.com/huylg/copilot.lua"
  },
  ["fidget.nvim"] = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-path", "cmp-vsnip", "vim-vsnip", "copilot-cmp" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
