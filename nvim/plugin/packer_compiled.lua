...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-copilot", "cmp-cmdline", "cmp-path", "cmp_luasnip" },
    loaded = true,
    only_config = true
  },
  ["nvim-dap"] = {
