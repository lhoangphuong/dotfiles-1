...
_G.packer_plugins = {
  ...
  ["lsp-inlayhints.nvim"] = {
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/lsp-inlayhints.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-copilot", "cmp-fuzzy-path", "cmp-buffer", "cmp-path", "cmp-tmux", "cmp-cmdline-history", "cmp_luasnip", "cmp-treesitter" },
