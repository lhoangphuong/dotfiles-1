...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-copilot", "cmp-path", "cmp-tmux", "cmp-treesitter", "cmp_luasnip", "cmp-fuzzy-path", "cmp-buffer", "cmp-cmdline", "cmp-cmdline-history" },
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
