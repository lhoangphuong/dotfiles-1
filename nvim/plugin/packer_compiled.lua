...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-copilot", "cmp-path", "cmp-tmux", "cmp-treesitter", "cmp_luasnip" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-refactor", "nvim-treesitter-rescript", "nvim-treesitter-textobjects", "playground" },
    loaded = true,
    only_config = true
  },
