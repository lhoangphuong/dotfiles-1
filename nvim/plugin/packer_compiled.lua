...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-tmux", "cmp-treesitter", "cmp_luasnip", "cmp-copilot", "cmp-buffer", "cmp-cmdline" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
