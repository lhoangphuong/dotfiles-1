...
_G.packer_plugins = {
  ...
  ["duck.nvim"] = {
    ...
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/duck.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-tmux", "cmp_luasnip", "cmp-buffer", "cmp-cmdline", "cmp-cmdline-history", "cmp-copilot", "cmp-fuzzy-path", "cmp-path", "cmp-treesitter" },
