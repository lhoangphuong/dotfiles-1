...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-path", "cmp-cmdline", "cmp-copilot", "cmp_luasnip", "cmp-tmux", "cmp-treesitter" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["pubspec-assist.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/opt/pubspec-assist.nvim",
...
vim.cmd [[au FileType dart ++once lua require("packer.load")({'pubspec-assist.nvim'}, { ft = "dart" }, _G.packer_plugins)]]
