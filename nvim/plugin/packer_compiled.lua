...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-copilot", "cmp-path", "cmp-tmux", "cmp-treesitter", "cmp_luasnip", "cmp-buffer", "cmp-cmdline" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
