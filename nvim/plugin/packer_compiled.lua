...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline", "cmp-treesitter", "cmp-copilot", "cmp_luasnip", "cmp-path", "cmp-tmux" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
