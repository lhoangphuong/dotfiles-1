...
_G.packer_plugins = {
  ...
  ["ToogleCommentHighlight.nvim"] = {
    loaded = true,
    path = "/Users/TVG/.local/share/nvim/site/pack/packer/start/ToogleCommentHighlight.nvim",
    url = "/Users/TVG/ToogleCommentHighlight.nvim"
  },
