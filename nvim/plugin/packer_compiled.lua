...
_G.packer_plugins = {
  ...
  ["clangd_extensions.nvim"] = {
    ...
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/clangd_extensions.nvim",
  ...
  ["csv.vim"] = {
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/csv.vim",
  ...
  ["flutter-riverpod-snippets"] = {
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/flutter-riverpod-snippets",
  ...
  ["gsearch.nvim"] = {
    ...
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/gsearch.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-copilot", "cmp-fuzzy-path", "cmp-path", "cmp-tmux", "cmp-treesitter", "cmp_luasnip", "cmp-buffer", "cmp-cmdline-history" },
  ...
  ["nvim-toggler"] = {
    ...
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/nvim-toggler",
  ...
  ["rest.nvim"] = {
    ...
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/rest.nvim",
  ...
  ["yaml-revealer"] = {
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/yaml-revealer",
