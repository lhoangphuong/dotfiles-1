...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-treesitter", "cmp_luasnip", "cmp-buffer", "cmp-tmux", "cmp-cmdline", "cmp-cmdline-history", "cmp-copilot", "cmp-fuzzy-path", "cmp-path" },
  ...
  ["vim-lldb"] = {
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/vim-lldb",
