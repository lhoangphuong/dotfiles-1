...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-buffer", "cmp-tmux", "cmp-copilot", "cmp-path", "cmp-treesitter", "cmp_luasnip" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["yaml.nvim"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/opt/yaml.nvim",
