...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-cmdline-history", "cmp-fuzzy-path", "cmp-path", "cmp-tmux", "cmp-treesitter", "cmp_luasnip", "cmp-copilot", "cmp-cmdline" },
  ...
  ["nvim-toggler"] = {
    config = { "\27LJ\2\n,\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\17nvim-toggler\frequire\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\n,\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\17nvim-toggler\frequire\0", "config", "nvim-toggler")
