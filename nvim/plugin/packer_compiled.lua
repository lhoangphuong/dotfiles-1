...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "playground", "nvim-treesitter-context", "nvim-treesitter-refactor" },
    loaded = true,
    only_config = true
  },
  ["nvim-treesitter-context"] = {
    config = { "\27LJ\2\n*\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\15ts-context\frequire\0" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
    path = "/Users/TVG/.local/share/nvim/site/pack/packer/opt/nvim-treesitter-context",
...
try_loadstring("\27LJ\2\n*\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\15ts-context\frequire\0", "config", "nvim-treesitter-context")
