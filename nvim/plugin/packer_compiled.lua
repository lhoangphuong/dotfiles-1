...
_G.packer_plugins = {
  ...
  ["colorbuddy.vim"] = {
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/colorbuddy.vim",
  ...
  ["gruvbuddy.nvim"] = {
    ...
    loaded = true,
    path = "/Users/hlg/.local/share/nvim/site/pack/packer/start/gruvbuddy.nvim",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline-history", "cmp-copilot", "cmp-fuzzy-path", "cmp-path", "cmp-tmux", "cmp_luasnip", "cmp-buffer", "cmp-treesitter", "cmp-cmdline" },
