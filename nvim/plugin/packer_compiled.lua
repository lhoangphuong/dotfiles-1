...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-copilot", "cmp-path", "cmp-tmux", "cmp-treesitter", "cmp_luasnip", "cmp-buffer" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-rescript", "nvim-treesitter-textobjects", "playground", "nvim-treesitter-refactor" },
    loaded = true,
    only_config = true
  },
