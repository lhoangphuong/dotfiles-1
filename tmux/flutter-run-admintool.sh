...
tmux new-window -t admintool-flutter-run 'cd $HOME/admintool-workspace/admintool; flutter run -t lib/int5.dart -d chrome --web-hostname 0.0.0.0 --web-port=7800; read -p "Press enter to continue"' 
